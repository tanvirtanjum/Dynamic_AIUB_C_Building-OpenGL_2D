...
void AIUB_C_BUILDING_WITH_RAIN()
{
    ...
    glVertex2f(xP + (radiusP * cos(iP *  twicePiP / triangleAmountP)),yP + (radiusP * sin(iP * twicePiP / triangleAmountP)));
    }
	glEnd();
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("AIUB C BUILDING WITH RAIN (Designed By 17-35860-3)");
	glutDisplayFunc(AIUB_C_BUILDING_WITH_RAIN);
